...
- TypeScript 5.3+, React Native 0.81+, Expo SDK 54 + expo, react-native, @issuedesk/shared, expo-secure-store, expo-linking, react-navigation (004-mobile-app)
- expo-secure-store (credentials), AsyncStorage (preferences), in-memory state (issues/labels) (004-mobile-app)
...
## Recent Changes
- 004-mobile-app: Added TypeScript 5.3+, React Native 0.81+, Expo SDK 54 + expo, react-native, @issuedesk/shared, expo-secure-store, expo-linking, react-navigation
