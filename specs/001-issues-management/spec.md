...
### User Story 3 - Label Management (Priority: P3)
...
### User Story 4 - Dashboard Analytics (Priority: P4)
...
### User Story 5 - Settings Configuration (Priority: P5)
...
- **FR-007**: System MUST provide markdown editor with "Code" and "Preview" toggle modes
...
- **FR-016**: System MUST store all data locally using one SQLite database per repository, with tables for issues, labels, sync queue, and repository metadata
- **FR-017**: System MUST sync local changes with GitHub repository when online using sequential processing of queued operations
...
- **SC-006**: View preferences (list/card) persist across app restarts
